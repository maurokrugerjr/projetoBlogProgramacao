...
<main id="post-container">
    <div class="content-container">
        <h1 id="main-title"><?= $currentPostId['title'] ?></h1>
        <p id="post-description"><?= $currentPostId['description'] ?></p>
        <div class="img-container">
            <img src="<?= $BASE_URL ?>/img/<?= $currentPostId['img'] ?>" alt="<?= $currentPostId['title'] ?>">
        </div>
    ...
    <aside id="nav-container">
        ...
        <ul id="tag-list">
            <?php foreach($currentPostId['tags'] as $tag): ?>
                <li><a href="#"><?= $tag ?></a></li>
            <?php endforeach; ?>
        </ul>
